...
<nav class="navbar navbar-inverse navbar-fixed-top">
    <div class="container-fluid bg-1">
        <div class="navbar-header">
            <a class="navbar-brand" href="/bs-sample"><img src="/asset/img/hygge.jpg" width="200" height="50"></a>

            <h5>Big Data Programming</h5>
        ...
        <div id="navbar" class="navbar-collapse collapse">
            ...
            <form class="navbar-form navbar-right" action="/bs_sample">
    ...
    <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
            ...
            <ul class="nav nav-sidebar">
                ...
                <li><a href=""><span class="glyphicon glyphicon-cloud" aria-hidden="true"></span>HTML/CSS/Javascript</a>
                </li>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        ...
        <div class="row placeholders">
            <div class="col-xs-6 col-sm-3 placeholder">
                ...
                <img src="/asset/img/min.jpg" width="200" height="200" class="img-circle"
                     alt="Generic placeholder thumbnail">
                <h4>MIN HEO</h4>
                <span class="text-muted">Project Manager</span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
                <img src="/asset/img/sewon.jpg" width="200" height="200" class="img-responsive"
                     alt="Generic placeholder thumbnail">
                <h4>SEWON KIM</h4>
                <span class="text-muted">Hadoop Engineer</span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
                <img src="/asset/img/soonsung.jpg" width="200" height="200" class="img-responsive"
                     alt="Generic placeholder thumbnail">
                <h4>SOONSUNG HWANG</h4>
                <span class="text-muted">UI/UX Developer</span>
            </div>
            <div class="col-xs-6 col-sm-3 placeholder">
                <img src="/asset/img/taejoon.jpg" width="200" height="200" class="img-responsive"
                     alt="Generic placeholder thumbnail">
                <h4>TAEJOON KIM</h4>
                <span class="text-muted">Hadoop Engineer</span>
            </div>
        ...
        <div class="table-responsive">
            <table class="table table-striped">
                ...
                <c:forEach var="amigo" items="${list}">
                    <tbody>
                    <tr>
                        <td>${amigo.amigoName}</td>
                        <td>${amigo.amigoNumber}</td>
                        <td>${amigo.amigoEmail}</td>
                    </tr>
                    </tbody>
                </c:forEach>
            </table>
